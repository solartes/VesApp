...
namespace VesApp.Backend.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "IdProject,UrlVideo,UrlImagen,Text,Titulo")] Project project)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "IdProject,UrlVideo,UrlImagen,Text,Titulo")] Project project)
        {
            if (ModelState.IsValid)
            {
